        ...
        return (
          <motion.div key={meta.debtId} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="glass-card rounded-2xl p-4 ios-shadow card-hover">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[10px] font-bold px-2.5 py-1 rounded-full bg-ios-surface-2 text-ios-text-secondary">{monthsLeft} payments left</span>
            </div>
...
export default function App() {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-ios-bg gradient-mesh overflow-hidden">
                ...
                return (
                  <div className="glass-card rounded-2xl p-4 ios-shadow card-hover">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-xs text-ios-text-secondary font-medium mb-0.5">Section 80C Limit</div>
